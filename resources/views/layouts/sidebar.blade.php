<nav class="pcoded-navbar">
    <div class="pcoded-inner-navbar main-menu">
        ...
        <ul class="pcoded-item pcoded-left-item">
            <li class="{{ request()->routeis('DashboardIndex') ? 'active' : '' }}">
                <a href="{{ route('DashboardIndex') }}">
                    <span class="pcoded-micon"><i class="feather icon-home"></i></span>
                    <span class="pcoded-mtext">Dashboard</span>
                </a>
            </li>
            <div class="pcoded-navigatio-lavel">Master Produk</div>
            <li class="pcoded-hasmenu {{ request()->routeis('Produk*') ? 'active pcoded-trigger' : '' }}">
                ...
                <ul class="pcoded-submenu">
                    <li class="{{ request()->routeis('ProdukIndex') ? 'active' : '' }}">
                        <a href="{{ route('ProdukIndex') }}">
                            <span class="pcoded-mtext">Data Produk</span>
                        </a>
                    </li>
                    <li class="{{ request()->routeis('ProdukImport') ? 'active' : '' }}">
                        <a href="{{ route('ProdukImport') }}">
                            <span class="pcoded-mtext">Import Produk</span>
                        </a>
                    </li>
                    <li class=" ">
