                ...
                <div class="card-block">
                    <div class="table-responsive">
                        <table class="table table-hover table-borderless">
                            ...
                            <tbody>
                                <tr>
                                    <td><img src="libraries/assets/images/widget/GERMANY.jpg" alt=""
                                ...
                                <tr>
                                    <td><img src="libraries/assets/images/widget/USA.jpg" alt=""
                                            class="img-fluid img-30"></td>
                                    <td>USA</td>
                                    <td>2,650</td>
                                ...
                                <tr>
                                    <td><img src="libraries/assets/images/widget/AUSTRALIA.jpg" alt=""
                                            class="img-fluid img-30"></td>
                                    <td>Australia</td>
                                    <td>956</td>
                                ...
                                <tr>
                                    <td><img src="libraries/assets/images/widget/UK.jpg" alt=""
                                            class="img-fluid img-30"></td>
                                ...
                                <tr>
                                    <td><img src="libraries/assets/images/widget/BRAZIL.jpg" alt=""
                                            class="img-fluid img-30"></td>
                                    <td>Brazil</td>
                                    <td>560</td>
        ...
        <div class="col-xl-8 col-md-12">
            <div class="card social-network">
                ...
                <div class="card-block">
                    <div class="row">
                        <div class="col-sm-6">
                            <img src="libraries/assets/images/widget/icon-1.png" alt=" "
                        ...
                        <div class="col-sm-6">
                            <img src="libraries/assets/images/widget/icon-2.png" alt=" "
                                class="img-responsive p-b-20">
                            <div class="row">
                                <div class="col-5">
                    ...
                    <div class="row">
                        <div class="col-sm-6 m-t-0">
                            <img src="libraries/assets/images/widget/icon-3.png" alt=" "
                        ...
                        <div class="col-sm-6 m-t-0">
                            <img src="libraries/assets/images/widget/icon-4.png" alt=" "
                                class="img-responsive p-b-10 p-t-10">
                            <div class="row">
                                <div class="col-5">
                                    <p class="text-muted m-b-5">Tweets :</p>
