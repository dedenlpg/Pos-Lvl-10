                    ...
                    <form class="md-float-material form-material">
                        ...
                        <div class="auth-box card">
                            <div class="card-block">
                                ...
                                <div class="row m-t-25 text-left">
                                    <div class="col-12">
                                        ...
                                        <div class="forgot-phone text-right f-right">
                                            <a href="auth-reset-password.htm" class="text-right f-w-600">
                                                Forgot Password?</a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-10">
                                        <p class="text-inverse text-left m-b-0">Saya belum punya akun</p>
                                        <p class="text-inverse text-left">
                                            <a href="{{ route('daftarIndex') }}"><b class="f-w-600">Daftar</b></a>
                                        </p>
                                    </div>
                                    <div class="col-md-2">
